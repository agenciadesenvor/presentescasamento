...
const RAW: SeedGift[] = [
  ...
  {
    id: "sunset-cordilheira-andes",
    slug: "sunset-cordilheira-andes",
    title: "Sunset na Cordilheira dos Andes",
    description:
      "Subir a Cordilheira no fim da tarde e ver o sol se pôr sobre os picos nevados, com o céu pegando fogo sobre os Andes. O espetáculo que fecha o dia no Chile.",
    category: "lua_de_mel",
    isFun: false,
    cotaPrice: 54900,
    totalCotas: 2,
  ...
  { id: "cafeteira", slug: "cafeteira", title: "Cafeteira elétrica", description: "Pra começar as manhãs do casal do jeito certo: café passado na hora, programável e com jarra grande — porque amor também se mede em xícaras. ☕", category: "cozinha", isFun: false, cotaPrice: 30000, totalCotas: 1, cotasSold: 0, photos: ["/gifts/cafeteira.jpg"], sortOrder: 52, active: true },
];
