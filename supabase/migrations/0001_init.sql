...
('ingresso-do-corinthians','Um ingresso pro jogo do Corinthians','Porque o noivo também merece sofrer fora do casamento. Cada cota é um lugar na arquibancada pra ele gritar com o juiz em paz.','divertidas',true,12000,11,'{"/gifts/neo-quimica-arena-1.jpg","/gifts/neo-quimica-arena-2.jpg"}',10),
('passeio-a-dois','Um passeio a dois','Pra lembrar que ainda existe vida (e romance) fora do sofá. Cada cota banca um rolê especial do casal — aquele programa que a gente sempre adia.','divertidas',true,30000,6,'{"https://images.unsplash.com/photo-1682024619121-aabb0305a496?w=1200&q=80&auto=format&fit=crop","https://images.unsplash.com/photo-1570075017462-b5478b3abfff?w=1200&q=80&auto=format&fit=crop"}',11)
