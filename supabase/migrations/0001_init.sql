...
('foto-chique-no-chile','Uma foto bonita no Chile','Pra provar pra geral que a lua de mel foi chique de doer. Cada cota é um clique digno de moldura (e de muita inveja no feed).','divertidas',true,9000,20,'{"https://images.unsplash.com/photo-1558517286-6b7b81953cb5?w=1200&q=80&auto=format&fit=crop","https://images.unsplash.com/photo-1715356758153-6d58ae44e8fe?w=1200&q=80&auto=format&fit=crop"}',9),
('ingresso-do-corinthians','Um ingresso pro jogo do Corinthians','Porque o noivo também merece sofrer fora do casamento. Cada cota é um lugar na arquibancada pra ele gritar com o juiz em paz.','divertidas',true,12000,11,'{"https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=1200&q=80&auto=format&fit=crop","https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=1200&q=80&auto=format&fit=crop"}',10),
('passeio-a-dois','Um passeio a dois','Pra lembrar que ainda existe vida (e romance) fora do sofá. Cada cota banca um rolê especial do casal — aquele programa que a gente sempre adia.','divertidas',true,30000,6,'{"https://images.unsplash.com/photo-1530789253388-582c481c54b0?w=1200&q=80&auto=format&fit=crop","https://images.unsplash.com/photo-1566759996874-04d713cc224a?w=1200&q=80&auto=format&fit=crop"}',11)
